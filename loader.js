...
export async function startWithCodeMirrorWithCroquet(args) {
  ...
  if (!strudelObj) {
    const { StrudelLib } = await import("./strudel/renkon-strudel.js");
    window.StrudelLib = StrudelLib;
    const { StrudelMirror } = await import("./strudel/StrudelMirror/codemirror.js");
    window.StrudelMirror = StrudelMirror;
    strudelObj = {StrudelLib, StrudelMirror};
  }
